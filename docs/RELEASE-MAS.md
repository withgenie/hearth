...
| 항목 | 값 |
| --- | --- |
| 마케팅 버전 | `1.0.1` (라이브) → `1.1.0` build `13` 심사 제출 |
| 마지막 업로드 빌드 | `13` (1.1.0, 2026-07-15 19:29 KST 업로드 승인) |
| ASC 상태 | `1.0.1` Ready for Sale, `1.1.0` build `13` VALID·연결 완료·Waiting for Review |
